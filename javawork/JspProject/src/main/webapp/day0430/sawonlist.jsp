...
<body>
	<div style="margin: 20px; width: 500px;">
		...
		<div style="margin: 20px 50px;">
			<button type="button" class="btn btn-success" style="width: 170px;" onclick="location.href='sawongenderalysis.jsp'">
				우리회사성별성적표
			</button>
			
			<button type="button" class="btn btn-success" style="width: 170px;" onclick="location.href='sawonbuseoalysis.jsp'">
				우리회사부서별성적표
			</button>
		</div>
		<%
