...
public class Ex3ThreadSwingCanvas extends JFrame implements ActionListener{
	...
	public Ex3ThreadSwingCanvas(String title) {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Ex3ThreadSwingCanvas a=new Ex3ThreadSwingCanvas("스레드예제");
