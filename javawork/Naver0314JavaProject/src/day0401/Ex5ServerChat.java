...
public class Ex5ServerChat extends JFrame implements Runnable{
	JTextArea area;
	Vector<ClientMember> list=new Vector<Ex5ServerChat.ClientMember>();
	ServerSocket serverSocket;
	
	public Ex5ServerChat(String title) {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Ex5ServerChat a=new Ex5ServerChat("채팅서버");
