...
public class Ex5ClientChat extends JFrame implements ActionListener,Runnable{
	JButton btnConnect;
	JLabel lblMessage;
	JTextArea area;
	...
	public Ex5ClientChat(String title) {
		...
		btnConnect.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					//창제목 닉네임으로 변경
					Ex5ClientChat.this.setTitle(nickName+"님의 채팅창");//창제목 변경
					//메세지도 변경
					lblMessage.setText("서버접속중..."+nickName);
					
					//스레드 시작
					Thread th=new Thread(Ex5ClientChat.this);
					th.start();//run 메소드 호출	
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Ex5ClientChat a=new Ex5ClientChat("클라이언트");
	}
