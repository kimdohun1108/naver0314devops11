...
public class Ex4Map {
	...
	public static void main(String[] args) {
		...
		//Map : key외 value의 쌍으로 저장되는 형태
		//이때 key타입이 set이므로 중복된 데이터 허용안하고 비순차적으로 들어간다
		Map<String,String> map1 = new HashMap<String, String>();
		map1.put("name", "김태희");
		map1.put("age", "35세");
		map1.put("addr", "서울");
		map1.put("name", "한가인");//기존값을 덮음 김태희->한가인
		...
		System.out.println("번호 : "+map1.get("hp"));//없는 key값을 넣을경우 null값으로 반환
