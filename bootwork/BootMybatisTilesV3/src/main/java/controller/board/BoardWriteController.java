...
public class BoardWriteController {
	...
	@GetMapping("/form")
	public String form(
			//새글일 경우 null값들이 넘어오므로 초기값을 지정
			//답글일 경우 원글이 갖고있는 각종 정보가 넘어옴
			...
			) 
	{
		...
		//업로드하지 않았을경우 "no" 저장, 업로드했을경우 랜덤 파일명으로 저장
		...
		//member db로부터 아이디에 해당하느 이름 얻어서 dto에 저장
		String writer = memberService.getData2(loginid).getName();
